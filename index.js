...
function getWinnersByYear(dataArray, finalsFunc, yearsFunc, winnersFunc) {
    let finalsArray = finalsFunc(dataArray);
    let yearsArray = yearsFunc(dataArray, finalsFunc);
    let winnersArray = winnersFunc(dataArray, finalsFunc)
    let stringArray = [];
